...
export default function LogoFaviconUploader() {
  ...
  const imageBaseUrl = "https://wingobd.onrender.com/images/";

  // Fetch current logo and favicon from the backend
  useEffect(() => {
    const fetchLogoFavicon = async () => {
      try {
        const response = await axios.get(`https://wingobd.onrender.com/admin/get-logo-favicon`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`https://wingobd.onrender.com/admin/upload-logo-favicon`, formData, {
