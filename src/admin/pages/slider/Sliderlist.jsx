...
const Sliderlist = () => {
  const base_url = "https://wingobd.onrender.com"; // Correct base URL for images
  ...
  useEffect(() => {
    const fetchBanners = async () => {
      try {
        const response = await axios.get("https://wingobd.onrender.com/admin/banners"); // Correct the URL
 ...
 const handleDeleteImage = async (imageName) => {
    try {
      ...
      const response = await axios.delete(`https://wingobd.onrender.com/admin/banners/${imageName}`);
